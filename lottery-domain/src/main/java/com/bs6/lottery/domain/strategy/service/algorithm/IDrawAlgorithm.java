...
public interface IDrawAlgorithm {
     ...
     * @param prizeProbabilityInfoList 奖品概率配置集合 「值示例：AwardRateInfo.awardRate = 0.04」
     */
    void initRateTuple(Long strategyId,Integer strategyMode, List<PrizeProbabilityInfo> prizeProbabilityInfoList);
     ...
     * @return              判断结果
     */
    boolean probabilityInfoIsExist(Long strategyId);
