...
@Component
public class RedemptionCode extends DistributeBase implements IDistributeGoods {
    @Override
    public DistributeRes doDistribution(GoodsReq req) {
        logger.info("模拟调用兑换码发放接口 uid：{} prizedContent：{}", req.getUid(), req.getPrizeContent());
